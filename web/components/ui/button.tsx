...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-none text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-signal text-signal-foreground shadow-none hover:bg-signal/90",
        destructive:
          "bg-destructive text-primary-foreground shadow-none hover:bg-destructive/90",
        outline:
          "border border-border bg-background/40 shadow-none hover:border-signal/50 hover:bg-muted/50 hover:text-foreground",
        secondary:
