...
| Ticker | Conviction | Verdict | Rationale (1 line) |
|--------|------------|---------|---------------------|
| **AMZN** | **Alta** | **BUY** | Great business; market overly penalizing FCF for $200B AI capex; AWS reaccelerating |
| GOOGL | Media | WATCHLIST | Quality + AI monetization proven; less variant perception; LP already +100% |
| HOOD | Media-Baja | PASS | Cyclical broker at P/E ~47; LP overlap; prediction markets hype > durable EPS today |
...
- Moat: brand, mobile UX, Gold ecosystem, product velocity (Agentic trading MCP = strategic relevance to us).
...
1. **LP already owns HOOD at +100%** — adding fund exposure = correlated book, not independent alpha.
...
1. **LP already +100% on Google** — same overlap issue as HOOD.
...
|----------|----------|--------|
| Q2 2026 earnings — AWS growth + capex ROI narrative | ~Late Jul 2026 | Re-rating if AWS ≥25% |
| Trainium workload ramp (OpenAI, Anthropic commitments) | H2 2026 | Validates silicon strategy |
| Advertising + retail efficiency | Ongoing | EPS leverage offsets capex fear |
| FCF inflection commentary | 2027 guidance hints | Multiple expansion |
...
|--------|--------|------|
| **BUY** | **AMZN** | **$45 (45%)** |
| WATCHLIST | GOOGL | $0 — revisit $320–340 |
| PASS | HOOD | $0 — LP overlap + valuation |
